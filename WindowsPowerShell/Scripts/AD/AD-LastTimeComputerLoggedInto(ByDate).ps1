# -------------------------------------------------------------------------------------
# Script:   LastTimeCOmputerLoggedInto(ByDate).ps1 
# Author:   knox 
# Date:     02/28/2013 09:15:47 
# Comments: Searches AD for the last time all computers were logged on
# to and sorts them from newst -> oldest
# -------------------------------------------------------------------------------------
...
If ($Accounts.Count –gt 0)
{
	...
	{ 
		$Result = "" | Select-Object Name,lastLogonTimestamp # Create an object to store this account in
